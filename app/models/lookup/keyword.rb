...
'concurrent chemoradiation therapy','carob','s-lar','dialysis clinic','ksi-301','tzh-chi esbl study','gold miners', 'low-risk','low risk, localized prostate cancer',
    ...
    def self.impossible_descriptions
      super + [
       ...
       'play',
       'poem',
       'policy, political ideology, solution',
       'political party',
       'political party, political party in germany',
       'pokémon move',
       'presenter',
       ...
       'recording studio',
       'record label',
       'religious text, mormon literature',
       'report',
       'river',
       'rock band',
       'route',
       ...
       'submarine class',
       'superpower',
       'teenage mutant ninja turtles adventures comic',
       'teleplay',
       'television program',
       'television series',
